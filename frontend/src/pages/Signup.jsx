...
import { FaEnvelope, FaLock, FaUser, FaGoogle, FaArrowLeft, FaMoon, FaSun } from 'react-icons/fa';
      ...
      <div className="flex items-center justify-center px-4 py-8" style={{ minHeight: '100vh', paddingTop: '120px' }}>
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-2xl mb-2" style={{ color: arcadeGreen, textShadow: `0 0 10px ${arcadeGreen}` }}>CREATE ACCOUNT</h2>
            <p className="text-sm" style={{ color: arcadeGreenDark }}>Join the coding revolution</p>
          </div>
          ...
          <div className="p-10 rounded-2xl" style={{ backgroundColor: `${arcadeGreen}10`, border: `2px solid ${arcadeGreen}` }}>
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Display Name Input */}
              <div>
                <label className="block text-sm mb-3" style={{ color: arcadeGreen }}>DISPLAY NAME</label>
                <div className="relative">
                  <FaUser className="absolute left-4 top-1/2 transform -translate-y-1/2" style={{ color: arcadeGreenDark }} />
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-sm mb-3" style={{ color: arcadeGreen }}>CONFIRM PASSWORD</label>
                <div className="relative">
                  <FaLock className="absolute left-4 top-1/2 transform -translate-y-1/2" style={{ color: arcadeGreenDark }} />
                  <input
                    type="password"
              ...
              <button 
                ...
                style={{ 
                  ...
                  opacity: isLoading || !email || !password || !confirmPassword || !displayName ? 0.5 : 1
                }}
              >
            ...
            <div className="text-center mt-8">
              <p className="text-sm" style={{ color: arcadeGreenDark }}>
                ...
                <Link to="/login" className="underline" style={{ color: arcadeGreen }}>
                  SIGN IN
                </Link>
              </p>
            </div>
